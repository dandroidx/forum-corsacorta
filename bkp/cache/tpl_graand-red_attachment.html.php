<?php if (!defined('IN_PHPBB')) exit; $__file_count = (isset($this->_tpldata['_file'])) ? sizeof($this->_tpldata['_file']) : 0;if ($__file_count) {for ($__file_i = 0; $__file_i < $__file_count; ++$__file_i){$__file_val = &$this->_tpldata['_file'][$__file_i]; if ($__file_val['S_DENIED']) {  ?>
	...
	<?php } else { if ($__file_val['S_THUMBNAIL']) {  ?>
		...
		<dl class="thumbnail">
			<dt><a href="<?php echo $__file_val['U_DOWNLOAD_LINK']; ?>"><img src="<?php echo $__file_val['THUMB_IMAGE']; ?>" alt="<?php echo $__file_val['DOWNLOAD_NAME']; ?>" title="<?php echo $__file_val['DOWNLOAD_NAME']; ?> (<?php echo $__file_val['FILESIZE']; ?> <?php echo $__file_val['SIZE_LANG']; ?>) <?php echo $__file_val['L_DOWNLOAD_COUNT']; ?>" class="attach_parent" /></a></dt>
		...
		<dl class="file">
			<dt class="attach-image"><img src="<?php echo $__file_val['U_INLINE_LINK']; ?>" alt="<?php echo $__file_val['DOWNLOAD_NAME']; ?>" onclick="viewableArea(this);" class="attach_me" /></dt>
