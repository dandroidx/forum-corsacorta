...
<!-- MOD : MSSTI ABBC3 (v<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>) - Start //--><?php $this->_tpl_include('./../../styles/abbcode/abbcode_header.html'); ?><!-- MOD : MSSTI ABBC3 (v<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>) - End //-->
</head>
