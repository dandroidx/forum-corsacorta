<?php if (!defined('IN_PHPBB')) exit; if ($this->_rootref['S_ABBC3_MOD']) {  ?>

<script type="text/javascript" src="<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/abbcode.js?<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>" charset="<?php echo (isset($this->_rootref['S_CONTENT_ENCODING'])) ? $this->_rootref['S_CONTENT_ENCODING'] : ''; ?>"></script>
<link rel="stylesheet" type="text/css" media="all" href="<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/abbcode.css?<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>" />

<?php if ($this->_rootref['S_ABBC3_RESIZE'] && ( $this->_rootref['S_NEW_MESSAGE'] || $this->_rootref['S_EDIT_POST'] || $this->_rootref['S_VIEWTOPIC'] || $this->_rootref['S_DISPLAY_PREVIEW'] || $this->_rootref['S_POST_REVIEW'] || $this->_rootref['S_DISPLAY_REVIEW'] || $this->_rootref['SIGNATURE'] ) || ( $this->_rootref['U_MCP'] && ( $this->_rootref['U_MCP_POST'] || $this->_rootref['U_MCP_TOPIC'] || $this->_rootref['U_MCP_FORUM'] ) ) || ( $this->_rootref['S_PRIVMSGS'] && ( $this->_rootref['S_VIEW_MESSAGE'] || $this->_rootref['S_DISPLAY_HISTORY'] ) ) || ( $this->_rootref['SEARCH_TITLE'] || $this->_rootref['SEARCH_MATCHES'] )) {  if ($this->_rootref['S_ABBC3_RESIZE_METHOD'] == ('HighslideBox')) {  ?>

	<script type="text/javascript" src="<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/highslide/highslide-full.js?<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>"></script>
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/highslide/highslide.css?<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>" />
	<style type="text/css">.controls-in-heading .highslide-controls { top: 25px; }</style>
	<!--[if lt IE 7]><link rel="stylesheet" type="text/css" href="<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/highslide/highslide-ie6.css?<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>" /><![endif]-->
	<?php } if ($this->_rootref['S_ABBC3_RESIZE_METHOD'] == ('Lightview')) {  ?><!-- Please, do not change these files, which have been adjusted to work with ABBC3 //-->
	<script type='text/javascript' src='<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/lightview/prototype.js?<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>'></script>
	<script type='text/javascript' src='<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/lightview/scriptaculous.js?load=effects'></script>
	<script type='text/javascript' src='<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/lightview/js/lightview.js?<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>'></script>
	<link rel="stylesheet" type="text/css" href="<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/lightview/css/lightview.css?<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>" />
	<style type="text/css" media="screen, projection">#lightview .clearfix { height: auto; }</style>
	<?php } if ($this->_rootref['S_ABBC3_RESIZE_METHOD'] == ('prettyPhoto')) {  ?>

	<link rel="stylesheet" type="text/css" media="all" href="<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/prettyPhoto/css/prettyPhoto.css?<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>" />
	<script type="text/javascript">
		window.jQuery || document.write(unescape('%3Cscript src="<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/prettyPhoto/js/jquery.min.js" type="text/javascript"%3E%3C/script%3E'));
	</script>
	<script type="text/javascript" src="<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/prettyPhoto/js/jquery.prettyPhoto.js?<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>"></script>
	<?php } if ($this->_rootref['S_ABBC3_RESIZE_METHOD'] == ('Shadowbox')) {  ?>

	<link rel="stylesheet" type="text/css" media="all" href="<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/shadowbox/shadowbox.css?<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>" />
	<script type="text/javascript" src="<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/shadowbox/shadowbox.js?<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>"></script>
	<?php } ?>


	<script type="text/javascript">
	// <![CDATA[
		var ImageResizerUseBar				= <?php echo (isset($this->_rootref['S_ABBC3_RESIZE_BAR'])) ? $this->_rootref['S_ABBC3_RESIZE_BAR'] : ''; ?>;
		var ImageResizerMode				= "<?php echo (isset($this->_rootref['S_ABBC3_RESIZE_METHOD'])) ? $this->_rootref['S_ABBC3_RESIZE_METHOD'] : ''; ?>";
		var ImageResizerMaxWidth_post		= <?php echo (isset($this->_rootref['S_ABBC3_MAX_IMG_WIDTH'])) ? $this->_rootref['S_ABBC3_MAX_IMG_WIDTH'] : ''; ?>;
		var ImageResizerMaxHeight_post		= <?php echo (isset($this->_rootref['S_ABBC3_MAX_IMG_HEIGHT'])) ? $this->_rootref['S_ABBC3_MAX_IMG_HEIGHT'] : ''; ?>;
		var ImageResizerSignature			= <?php echo (isset($this->_rootref['S_ABBC3_RESIZE_SIGNATURE'])) ? $this->_rootref['S_ABBC3_RESIZE_SIGNATURE'] : ''; ?>;
		var ImageResizerMaxWidth_sig		= <?php echo (isset($this->_rootref['S_ABBC3_MAX_SIG_WIDTH'])) ? $this->_rootref['S_ABBC3_MAX_SIG_WIDTH'] : ''; ?>;
		var ImageResizerMaxHeight_sig		= <?php echo (isset($this->_rootref['S_ABBC3_MAX_SIG_HEIGHT'])) ? $this->_rootref['S_ABBC3_MAX_SIG_HEIGHT'] : ''; ?>;
	...
	<?php if ($this->_rootref['S_ABBC3_RESIZE_METHOD'] == ('AdvancedBox')) {  ?>
	...
	/** Image Resizer JS and AdvancedBox JS - Start **/
		...
		var ImageResizerBlankImage			= "<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/advancedbox_blank.gif";
	/** Image Resizer JS and AdvancedBox JS - End **/
	<?php } if ($this->_rootref['S_ABBC3_RESIZE_METHOD'] == ('HighslideBox')) {  ?>
	...
	/** Image Resizer JS with Highslide JS - End **/
		...
		hs.graphicsDir = "<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/highslide/graphics/";
		hs.align = 'center';
	...
	<script type="text/javascript" src="<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/AdvancedBox.js?<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>"></script>
	<?php } ?>


	<script type="text/javascript" src="<?php echo (isset($this->_rootref['S_ABBC3_PATH'])) ? $this->_rootref['S_ABBC3_PATH'] : ''; ?>/abbcode_ImgResizer.js?<?php echo (isset($this->_rootref['S_ABBC3_VERSION'])) ? $this->_rootref['S_ABBC3_VERSION'] : ''; ?>"></script>
	
	<?php if ($this->_rootref['S_ABBC3_RESIZE_BAR']) {  ?>
