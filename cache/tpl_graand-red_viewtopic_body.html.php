...
<?php } $_postrow_count = (isset($this->_tpldata['postrow'])) ? sizeof($this->_tpldata['postrow']) : 0;if ($_postrow_count) {for ($_postrow_i = 0; $_postrow_i < $_postrow_count; ++$_postrow_i){$_postrow_val = &$this->_tpldata['postrow'][$_postrow_i]; if ($this->_tpldata['DEFINE']['.']['PROFILE_SIDE'] == ('left')) {  ?><div class="profilesleft"><?php } if ($_postrow_val['S_FIRST_UNREAD']) {  ?><a id="unread"></a><?php } ?>
	...
	<?php } ?>
		...
		<div class="back2top"><a href="#wrap2" class="top" title="<?php echo ((isset($this->_rootref['L_BACK_TO_TOP'])) ? $this->_rootref['L_BACK_TO_TOP'] : ((isset($user->lang['BACK_TO_TOP'])) ? $user->lang['BACK_TO_TOP'] : '{ BACK_TO_TOP }')); ?>"><?php echo ((isset($this->_rootref['L_BACK_TO_TOP'])) ? $this->_rootref['L_BACK_TO_TOP'] : ((isset($user->lang['BACK_TO_TOP'])) ? $user->lang['BACK_TO_TOP'] : '{ BACK_TO_TOP }')); ?></a></div>

		<span class="corners-bottom"><span></span></span></div>
	</div>

	<hr class="divider" />
<?php if ($this->_tpldata['DEFINE']['.']['PROFILE_SIDE'] == ('left')) {  ?></div><?php } }} if ($this->_rootref['S_QUICK_REPLY']) {  $this->_tpl_include('quickreply_editor.html'); } if ($this->_rootref['S_NUM_POSTS'] > (1) || $this->_rootref['PREVIOUS_PAGE']) {  if ($this->_tpldata['DEFINE']['.']['EXPAND_VIEW'] == ('on')) {  ?><div class="expandcollapse"><?php } ?>	
